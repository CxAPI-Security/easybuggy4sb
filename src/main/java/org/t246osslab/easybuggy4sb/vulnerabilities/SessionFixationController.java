...
public class SessionFixationController extends DefaultLoginController {
    ...
    @Override
    @RequestMapping(value = Config.APP_ROOT + "/sessionfixation/login", method = RequestMethod.GET)
    ...
    @Override
    @RequestMapping(value = Config.APP_ROOT + "/sessionfixation/login", method = RequestMethod.POST)
